...
public class MergeLead extends BaseClass {
	...
	public void MergeLeadMethod(String name1, String name2) throws InterruptedException {
		...
		driver.findElement(By.xpath("//button[text()='Find Leads']")).click();
		Thread.sleep(1000);
		WebElement leadWE = driver.findElement(By.xpath("//div[@class='x-grid3-cell-inner x-grid3-col-partyId']/a"));
		leadWE.click();
	...
	public String[][] mergeLeadData() throws IOException{
		return DataStash.runMergeLead("MergeLead","Sheet1");
	}
